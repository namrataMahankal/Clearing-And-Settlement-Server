insert into clearing_member(clearingMemberId, amountToPay, clearingMemberFundBalance, clearingMemberName,interestRate, netPayable, shortage) values(1001,0,FLOOR((RAND()*500000)+1000000),"Citi",1.25,0,0);
insert into clearing_member(clearingMemberId, amountToPay, clearingMemberFundBalance, clearingMemberName,interestRate, netPayable, shortage) values(1002,0,FLOOR((RAND()*500000)+1000000),"JP Morgan Chase",1.25,0,0);
insert into clearing_member(clearingMemberId, amountToPay, clearingMemberFundBalance, clearingMemberName,interestRate, netPayable, shortage) values(1003,0,FLOOR((RAND()*500000)+1000000),"Bank of New York Mellon",1.25,0,0);
insert into clearing_member(clearingMemberId, amountToPay, clearingMemberFundBalance, clearingMemberName,interestRate, netPayable, shortage) values(1004,0,FLOOR((RAND()*500000)+1000000),"State Street Corporation",1.25,0,0);
insert into clearing_member(clearingMemberId, amountToPay, clearingMemberFundBalance, clearingMemberName,interestRate, netPayable, shortage) values(1005,0,FLOOR((RAND()*500000)+1000000),"BNP Paribas Securities Services",1.25,0,0);
insert into clearing_member(clearingMemberId, amountToPay, clearingMemberFundBalance, clearingMemberName,interestRate, netPayable, shortage) values(1006,0,FLOOR((RAND()*500000)+1000000),"HSBC Securities Services",1.25,0,0);
insert into clearing_member(clearingMemberId, amountToPay, clearingMemberFundBalance, clearingMemberName,interestRate, netPayable, shortage) values(1007,0,FLOOR((RAND()*500000)+1000000),"Northern Trust Corporation",1.25,0,0);
insert into clearing_member(clearingMemberId, amountToPay, clearingMemberFundBalance, clearingMemberName,interestRate, netPayable, shortage) values(1008,0,FLOOR((RAND()*500000)+1000000),"UBS AG",1.25,0,0);
insert into clearing_member(clearingMemberId, amountToPay, clearingMemberFundBalance, clearingMemberName,interestRate, netPayable, shortage) values(1009,0,FLOOR((RAND()*500000)+1000000),"Wells Fargo",1.25,0,0);
insert into clearing_member(clearingMemberId, amountToPay, clearingMemberFundBalance, clearingMemberName,interestRate, netPayable, shortage) values(10010,0,FLOOR((RAND()*500000)+1000000),"Credit Suisse",1.25,0,0);
...
insert into corporate_action(corporateActionId,securityId,action,parameter) values(6,11,"stock-dividend","8");
