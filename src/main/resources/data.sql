...
insert into clearing_member(clearingMemberId, amountToPay, clearingMemberFundBalance, clearingMemberName,interestRate, netPayable, shortage, corporateActionChange) values(1003,0,FLOOR((RAND()*500000)+1000000),"BNY Mellon",1.25,0,0,0);
insert into clearing_member(clearingMemberId, amountToPay, clearingMemberFundBalance, clearingMemberName,interestRate, netPayable, shortage, corporateActionChange) values(1004,0,FLOOR((RAND()*500000)+1000000),"State Street",1.25,0,0,0);
insert into clearing_member(clearingMemberId, amountToPay, clearingMemberFundBalance, clearingMemberName,interestRate, netPayable, shortage, corporateActionChange) values(1005,0,FLOOR((RAND()*500000)+1000000),"BNP Paribas",1.25,0,0,0);
insert into clearing_member(clearingMemberId, amountToPay, clearingMemberFundBalance, clearingMemberName,interestRate, netPayable, shortage, corporateActionChange) values(1006,0,FLOOR((RAND()*500000)+1000000),"HSBC Securities",1.25,0,0,0);
insert into clearing_member(clearingMemberId, amountToPay, clearingMemberFundBalance, clearingMemberName,interestRate, netPayable, shortage, corporateActionChange) values(1007,0,FLOOR((RAND()*500000)+1000000),"Northern Trust",1.25,0,0,0);
...
insert into securities(securityId, interestRate, marketPrice, securityName) values(1,FLOOR((RAND()*20)+1),ROUND(RAND()*(300-10+1)+10,2),"Amazon");
insert into securities(securityId, interestRate, marketPrice, securityName) values(2,FLOOR((RAND()*20)+1),ROUND(RAND()*(300-10+1)+10,2),"Apple");
--insert into securities(securityId, interestRate, marketPrice, securityName) values(3,FLOOR((RAND()*20)+1),RAND()*(300-10+1)+10,"Micro");
insert into securities(securityId, interestRate, marketPrice, securityName) values(4,FLOOR((RAND()*20)+1),ROUND(RAND()*(300-10+1)+10,2),"UBER");
insert into securities(securityId, interestRate, marketPrice, securityName) values(5,FLOOR((RAND()*20)+1),ROUND(RAND()*(300-10+1)+10,2),"FORD");
insert into securities(securityId, interestRate, marketPrice, securityName) values(6,FLOOR((RAND()*20)+1),ROUND(RAND()*(300-10+1)+10,2),"Tesla");
...
insert into securities(securityId, interestRate, marketPrice, securityName) values(8,FLOOR((RAND()*20)+1),ROUND(RAND()*(300-10+1)+10,2),"AT&T");
...
insert into securities(securityId, interestRate, marketPrice, securityName) values(10,FLOOR((RAND()*20)+1),ROUND(RAND()*(300-10+1)+10,2),"Google");
...
insert into securities(securityId, interestRate, marketPrice, securityName) values(13,FLOOR((RAND()*20)+1),ROUND(RAND()*(300-10+1)+10,2),"TEXAS");
...
insert into securities(securityId, interestRate, marketPrice, securityName) values(15,FLOOR((RAND()*20)+1),ROUND(RAND()*(300-10+1)+10,2),"NVIDIA");
